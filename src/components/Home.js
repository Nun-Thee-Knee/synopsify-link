    ...
    <div className='h-auto bg-black'>
        <div className='flex p-20 bg-black flex-wrap space-x-32 justify-center'>
            <div className='flex flex-col justify-center items-start text-white  h-[400px] w-auto'>
              ...
              <p className='text-xl mt-10 w-96'>Changed Transforming Complex Video Narratives into Clear and Actionable Text Summaries: Your Link, Your Knowledge Unleashed.</p>
