  ...
  return (
    <div className='h-auto bg-black'>
        <div className='flex p-20 bg-black flex-wrap space-x-32 justify-center'>
            <div className='flex flex-col justify-center items-start text-white  h-[400px] w-[500px]'>
              <h1 className='text-7xl font-extrabold'><span className='text-red-800'>Synopsify</span>Link</h1>
              <p className='text-xl mt-10'>Transforming Complex Video Narratives into Clear and Actionable Text Summaries: Your Link, Your Knowledge Unleashed.</p>
